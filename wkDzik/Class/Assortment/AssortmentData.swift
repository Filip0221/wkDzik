...
class AssortmentData: NSObject, Identifiable, ObservableObject{
    ...
    @Published var bascet: [any Assortment] = []
    @Published var assortment: [any Assortment] = [
    ...
    func duplicatesCount() -> [(assortment: any Assortment, count: Int)]{
        ...
        var basketArray: [(assortment: any Assortment, count: Int)] = []
